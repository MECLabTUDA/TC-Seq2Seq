...
root = '../../../results/MotionUNIT_CATARACTS_Cataract101_192pix/2022_10_24-10_40_01/'
...
test_ds = Img2ImgDataset(ds_A=train_ds_A, ds_B=train_ds_B)
...
print("##### Loading model.")
agent = UNIT(conf)
agent.gen_A.load_state_dict(torch.load(root + 'checkpoints/gen_A_epoch189.pth', map_location='cpu'))
agent.gen_B.load_state_dict(torch.load(root + 'checkpoints/gen_B_epoch189.pth', map_location='cpu'))
